...
#SBATCH --output=ddam_log/output_moe-grouped_top-p_aux-0.5_lora_bal-mix.log
#SBATCH --error=ddam_log/error_moe-grouped_top-p_aux-0.5_lora_bal-mix.log
...
TASK=ddam_moe-grouped_top-p_aux-0.5_lora_bal-mix
...
# export PYTHONHASHSEOLMoE-ILSP/SimilarityMoE/tensorboard_logsED=42
# export CUDA_LAUNCH_BLOCKING=1

accelerate launch --config_file $WORK_MOE/scripts/multi_gpu.yaml moe_sft.py \
  --model_name_or_path $WORK_MOE/moe_models/base/ddam_qwen3_0.6B-moe-grouped_top-p_aux-0.5 \
